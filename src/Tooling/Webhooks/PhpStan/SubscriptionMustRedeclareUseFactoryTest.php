...
/** @extends RuleTestCase<SubscriptionMustRedeclareUseFactory> */
#[CoversClass(SubscriptionMustRedeclareUseFactory::class)]
final class SubscriptionMustRedeclareUseFactoryTest extends RuleTestCase
{
    use GetsFixtures;

    protected function getRule(): Rule
    {
        return new SubscriptionMustRedeclareUseFactory;
    }
    ...
    {
        $this->analyse([$this->getFixturePath('Webhooks/SubscriptionWithoutUseFactory.php')], [
            [
                'A '.class_basename(Subscription::class).' subclass must redeclare #['
                    .class_basename(UseFactory::class).']. PHP does not inherit attributes.',
                12,
            ],
        ]);
    }
