...
final class AutoDisableTest extends TestCase
{
    ...
    {
        config(['webhooks.subscriptions.failures.threshold' => 3]);
    ...
    {
        config(['webhooks.subscriptions.failures.threshold' => 0]);
    ...
    {
        config(['webhooks.subscriptions.failures.threshold' => 1]);
